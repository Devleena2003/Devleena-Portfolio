    ...
    <section ref={sectionRef} id="experiences" className="py-24">
     <div className="text-left mb-10">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-slate-700/30"></div>
        
        {/* Animated progress line */}
        <motion.div 
          className="absolute left-1/2 -translate-x-1/2 top-0 w-0.5 bg-gradient-to-b from-purple-500 to-fuchsia-500"
          style={{ 
            height: lineHeight,
            transformOrigin: 'top'
          }}
