        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Textarea id="message" name="message" placeholder="Your feedback or message..." required rows={50} value={formData.message} onChange={handleInputChange} className="mt-2 bg-slate-800 border-slate-700 focus:ring-purple-500" />
            </div>
